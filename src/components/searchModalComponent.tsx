...
import {useCountries} from "./getCountries"
		...
		<Dialog>
			<DialogTrigger asChild>
				<div className="rounded-full py-2 px-5 border flex items-center cursor-pointer">
					...
					<FaSearch className="bg-primary text-white p-2 h-8 w-8 rounded-full" />
				</div>
			</DialogTrigger>
				...
				<form className="gap-4 flex flex-col">
					...
					{step===1 ? (
						<>
							...
							<Select required value={locationValue} onValueChange={value=>setLocationValue(value)}>
